...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Stat',
            fields=[
                ('stat_id', models.CharField(default=django.utils.timezone.now, max_length=32, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Multiplier',
            fields=[
                ('mult_id', models.CharField(default=django.utils.timezone.now, max_length=32, primary_key=True, serialize=False)),
