    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stat_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db_api.pokemon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mult_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db_api.pokemon')),
            ],
            options={
